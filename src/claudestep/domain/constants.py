"""Domain constants for ClaudeStep application.

Defines application-wide default values and constants that are reusable
across different layers of the application.
"""

# Default GitHub label for ClaudeStep PRs
DEFAULT_PR_LABEL = "claudestep"

# Default base branch
DEFAULT_BASE_BRANCH = "main"

# Default metadata branch
DEFAULT_METADATA_BRANCH = "claudestep-metadata"
